...
public class Loader {
	...
	public int loadCubeMap(String[] textureFiles){
		...
		for(int i=0;i<textureFiles.length;i++){
			...
			//Loop loads one skybox image to each face opf the sky box cube
	...
	public int loadTexture(String fileName) {
		...
		try {
			...
			GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL14.GL_TEXTURE_LOD_BIAS, -0.4f);	//TODO move to settings. more negative = higher level of details for downsampled textures
